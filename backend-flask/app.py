...
LOGGER.info("some log message from App.py")

# Honecomb ------------- Import Library
...
# Honecomb ------------- Initialize tracing and an exporter that can send data to Honeycomb
...
# show this log within the backend-flash STDOUT
...
# Honecomb -------------Initialize automatic instrumentation with Flask
